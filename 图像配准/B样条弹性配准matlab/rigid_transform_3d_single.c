...
/* Imrigide transform Iout=rigide_transform_3d_float(Iin,Minv)
...
{
    float *Isize_d, *mean, *A, *Iin, *Iout, *ThreadID;
    int Isize[3]={0,0,0};
                  ...
                  int nrhs, const mxArray *prhs[] )
{
    ...
    ThreadArgs1 = (float **)malloc( 6* sizeof( float * ) );  
    ThreadArgs2 = (float **)malloc( 6* sizeof( float * ) );  
